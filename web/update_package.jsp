...
<div class="form-box">
  ...
  <form method="get">
    <input type="text" name="booking_id" placeholder="Enter Package Booking ID" required>
...
if (idParam != null && !idParam.isEmpty()) {
    ...
    try {
        ...
        if (rs.next()) {
            booking_id = rs.getString("booking_id"); // FIXED
            customer_id = rs.getString("customer_id"); // If exists in table
...
<%
            ...
            out.println("<p style='color:red; text-align:center;'>Package Booking ID not found.</p>");
        }
